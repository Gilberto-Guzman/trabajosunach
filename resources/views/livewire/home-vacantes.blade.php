...
<div>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-white shadown-sm rounded-lg p-6 divide-y divide-gray-200">
                @forelse ( $vacantes as $vacante)
                    <div class="md:flex md:justify-between md:items-center py-5">
                        ...
                        <div class="mt-5 md:mt-0">
                            <a
                                class="bg-slate-800 p-3 text-sm uppercase font-bold text-white rounded-lg block text-center"
